/**
 * @module @kb-labs/studio-app/components/widgets/JsonViewer
...
export interface JsonViewerProps extends BaseWidgetProps<unknown, JsonViewerOptions> {}
...
export function JsonViewer({ data, loading, error, options }: JsonViewerProps) {
