/**
 * @module @kb-labs/studio-app/components/widgets/display/Diff
...
import type { DiffOptions as ContractOptions, DiffData } from '@kb-labs/studio-contracts';
...
export interface DiffOptions extends ContractOptions {}

export interface DiffProps extends BaseWidgetProps<DiffData, DiffOptions> {}

export function Diff({ data, loading, error, options }: DiffProps) {
