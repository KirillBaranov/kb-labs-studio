...
import { Select, List, Typography, Tag, Empty, Space } from 'antd';
                ...
                renderItem={(commit: any, index: number) => (
                  <List.Item>
                    <List.Item.Meta
                      ...
                      title={
                        <Space>
                          <Tag color={getTypeColor(commit.type)}>{commit.type}</Tag>
                          {commit.scope && <Tag>{commit.scope}</Tag>}
                          <Text strong>{commit.subject}</Text>
                        </Space>
                      }
                      description={
                        <>
                          {commit.body && <Paragraph>{commit.body}</Paragraph>}
