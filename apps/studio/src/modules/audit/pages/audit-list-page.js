...
export function AuditListPage() {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-bold", children: "Audit" }), _jsx("p", { className: "mt-2", children: "Package audit results and reports" })] }), _jsx(KBButton, { children: "Run Audit" })] }), _jsxs(KBCard, { children: [_jsx(KBCardHeader, { children: _jsx(KBCardTitle, { children: "Summary" }) }), _jsx(KBCardContent, { children: isLoading ? (_jsxs("div", { className: "space-y-2", children: [_jsx(KBSkeleton, { className: "h-8 w-full" }), _jsx(KBSkeleton, { className: "h-8 w-full" })] })) : data ? (_jsx("div", { className: "space-y-4", children: _jsxs("div", { className: "grid grid-cols-2 gap-4 md:grid-cols-4", children: [_jsxs("div", { children: [_jsx("p", { className: "text-sm text-secondary", children: "Total Packages" }), _jsx("p", { className: "text-2xl font-bold", children: data.totals.packages })] }), _jsxs("div", { children: [_jsx("p", { className: "text-sm text-secondary", children: "OK" }), _jsx("p", { className: "text-2xl font-bold text-green-600", children: data.totals.ok })] }), _jsxs("div", { children: [_jsx("p", { className: "text-sm text-secondary", children: "Warnings" }), _jsx("p", { className: "text-2xl font-bold text-yellow-600", children: data.totals.warn })] }), _jsxs("div", { children: [_jsx("p", { className: "text-sm text-secondary", children: "Failed" }), _jsx("p", { className: "text-2xl font-bold text-red-600", children: data.totals.fail })] })] }) })) : null })] }), _jsxs(KBCard, { children: [_jsx(KBCardHeader, { children: _jsx(KBCardTitle, { children: "Packages" }) }), _jsx(KBCardContent, { children: isLoading ? (_jsxs("div", { className: "space-y-2", children: [_jsx(KBSkeleton, { className: "h-10 w-full" }), _jsx(KBSkeleton, { className: "h-10 w-full" }), _jsx(KBSkeleton, { className: "h-10 w-full" })] })) : (_jsx(DataTable, { columns: columns, data: tableData, onRowClick: (row) => setSelectedPackage(row.package) })) })] }), _jsx(AuditReportDrawer, { packageName: selectedPackage, onClose: () => setSelectedPackage(null) })] }));
}
